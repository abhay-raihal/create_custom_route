...
abstract class AccountAPIAbstractClient
{
     ...
     * {@inheritdoc}
     */
    public function FetchMerchant(array $ctx, \Rzp\Accounts\Account\V1\FetchMerchantRequest $in): \Rzp\Accounts\Account\V1\FetchMerchantResponse
    {
        $ctx = Context::withPackageName($ctx, 'rzp.accounts.account.v1');
        $ctx = Context::withServiceName($ctx, 'AccountAPI');
        $ctx = Context::withMethodName($ctx, 'FetchMerchant');

        $out = new \Rzp\Accounts\Account\V1\FetchMerchantResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.accounts.account.v1.AccountAPI/FetchMerchant';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.accounts.account.v1.AccountAPI/FetchMerchant';
        }
